...
public class myPlayService extends Service implements OnCompletionListener,
	...
	public static final String BROADCAST_ACTION = "com.music.test.musicpro.seekprogress";

	// Set up broadcast identifier and intent
	public static final String BROADCAST_BUFFER = "com.music.test.musicpro.broadcastbuffer";
...
public boolean playing()
{
	...
	public void playSong(){
		...
		//if (!mediaPlayer.isPlaying()) {
			...
			try {
				mediaPlayer.setDataSource(Constant.playListUrl.get(Constant.postion));
	...
	public void onCompletion(MediaPlayer mp) {
		...
		/*stopMedia();
		stopSelf();*/
		Toast.makeText(myPlayService.this, "complete", Toast.LENGTH_SHORT).show();
		...
		if (Constant.postion+1>=Constant.playListName.size())
		{
			...
			try {
				mediaPlayer.setDataSource(Constant.playListUrl.get(Constant.postion+1));
			} catch (IllegalArgumentException e) {
				e.printStackTrace();
			} catch (IllegalStateException e) {
				e.printStackTrace();
